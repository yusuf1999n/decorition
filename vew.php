	...
	<body class="is-preload">
		...
		<!-- Wrapper -->
			<div id="wrapper" class="fade-in">
				...
				<!-- Header -->
					<header id="header">
						<a href="index.html" class="logo"> ديكورات داخليه</a>
					</header>
				...
				<div id="main">
					...
					<!-- Featured Post -->
						<br class="post featured">
                            ...
                            <?php
        foreach ($photos as $IntDecor) {
            echo "<img src='uploads/$IntDecor' alt='IntDecor' onclick=\"openModal();currentSlide(1)\">";
        }
        ?>
                            ...
                            <div id="myModal" class="modal"  style="display:none;">
                                ...
                                <?php
    foreach ($photos as $index => $IntDecor) {
        echo "<div class='mySlides' id='slide$index'>";
        echo "<img src='uploads/$IntDecor' alt='IntDecor' onclick=\"openModal();currentSlide(".($index+1).")\">";
        echo "</div>";
    }
