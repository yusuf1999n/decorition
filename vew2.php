	...
	<body class="is-preload">
		...
		<!-- Wrapper -->
			<div id="wrapper" class="fade-in">
				...
				<!-- Header -->
					<header id="header">
						<a href="index.html" class="logo"> واجهات خارجيه</a>
					</header>
				...
				<!-- Nav -->
					<nav id="nav">
						<ul class="links" >
							...
							<li class="active"><a href="vew2.php">واجهات خارجيه</a></li>
				...
				<div id="main">
					...
					<!-- Featured Post -->
						<br class="post featured">
                            ...
                            <?php
        foreach ($photos as $ExtDecor) {
            echo "<img src='uploads/$ExtDecor' alt='ExtDecor' onclick=\"openModal();currentSlide(1)\">";
        }
        ?>
                            ...
                            <div id="myModal" class="modal">
                                ...
                                <?php
    foreach ($photos as $index => $ExtDecor) {
        echo "<div class='mySlides' id='slide$index'>";
        echo "<img src='uploads/$ExtDecor' alt='ExtDecor' onclick=\"openModal();currentSlide(".($index+1).")\">";
        echo "</div>";
    }
    ?>
