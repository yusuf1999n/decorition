	...
	<body class="is-preload">
		...
		<!-- Wrapper -->
			<div id="wrapper" class="fade-in">
				...
				<!-- Header -->
					<header id="header">
						<a href="index.html" class="logo"> دهانات خارجيه</a>
					</header>
				...
				<!-- Nav -->
					<nav id="nav">
						<ul class="links" >
							...
							<li class="active"><a href="vew4.php"> دهانات خارجيه</a></li>
				...
				<div id="main">
					...
					<!-- Featured Post -->
						<br class="post featured">
                            ...
                            <?php
        foreach ($photos as $ExtPaint) {
            echo "<img src='uploads/$ExtPaint' alt='ExtPaint' onclick=\"openModal();currentSlide(1)\">";
        }
        ?>
                            ...
                            <div id="myModal" class="modal"  style="display:none;">
                                ...
                                <?php
    foreach ($photos as $index => $ExtPaint) {
        echo "<div class='mySlides' id='slide$index'>";
        echo "<img src='uploads/$ExtPaint' alt='ExtPaint' onclick=\"openModal();currentSlide(".($index+1).")\">";
        echo "</div>";
    }
    ?>
