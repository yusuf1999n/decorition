	...
	<body class="is-preload">
		...
		<!-- Wrapper -->
			<div id="wrapper" class="fade-in">
				...
				<!-- Header -->
					<header id="header">
						<a href="index.html" class="logo"> دهانات داخليه</a>
					</header>
				...
				<!-- Nav -->
					<nav id="nav">
						<ul class="links" >
							...
							<li class="active"><a href="vew3.php">دهانات داخليه</a></li>
				...
				<div id="main">
					...
					<!-- Featured Post -->
						<br class="post featured">
                            ...
                            <?php
        foreach ($photos as $IntPaint) {
            echo "<img src='uploads/$IntPaint' alt='IntPaint' onclick=\"openModal();currentSlide(1)\">";
        }
        ?>
                            ...
                            <div id="myModal" class="modal"  style="display:none;">
                                ...
                                <?php
    foreach ($photos as $index => $IntPaint) {
        echo "<div class='mySlides' id='slide$index'>";
        echo "<img src='uploads/$IntDecor' alt='IntPaint' onclick=\"openModal();currentSlide(".($index+1).")\">";
        echo "</div>";
    }
    ?>
